...
export default function RegisterEventForm(): React.ReactElement {
  ...
  const [img64Base, setImg64Base] = React.useState<string | undefined>(
    undefined,
  );
  ...
  const onSubmit = (data: FormFields) => {
    ...
    const event = {
      ...
      start_date: prepareDateEventInfo(
        data.startdate,
        wholeDayEvent ? "" : data.starttime,
      ),
      end_date: wholeDayEvent
        ? ""
        : prepareDateEventInfo(data.enddate, data.endtime),
        ...
        >
          <div className={styles.eventDetailsContainer}>
            ...
            <div className={styles.inputGridContainer}>
              <div
                className={styles.gridHalfColumn}
              ...
              >
                <TextFieldBase
                  ...
                  type="date"
                  fullwidth={true}
                  defaultvalue={initValues.startdate}
            ...
            >
              <CheckBox
                title="Whole day"
                checked={wholeDayEvent}
                onClick={handleWholeDayEvent}
              />
            </div>
            <div className={styles.inputGridContainer}>
              <div
          ...
          <div className={styles.providerDetailsContainer}>
            ...
            <div className={styles.inputGridContainer}>
              <div
                className={styles.gridFullColumn}
                style={{ gridColumn: "span 5" }}
              >
                <TextFieldBase
                  id="city"
          ...
          <div
            className={styles.providerFooterContainer}
