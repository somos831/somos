...
const Banner:React.FC<BannerProps> = ({ title, background, body="", height=300, tabletHeight=-1, mobileHeight=-1, justifyContent="center", alignItems="center", py="", variation="", decoration=false }) => {
  ...
  return (
    <div>
      <div className={styles.container} style={containerStyle}>
        ...
        <div style={containerBackStyle} className={styles.backgroundContainer}></div>
      </div>
      {decoration && (
          <p className={styles.backDecoration}></p>
        )}
    </div>
  )
}
